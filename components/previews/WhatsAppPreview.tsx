...
export default function WhatsAppPreview({ meta }: WhatsAppPreviewProps) {
  ...
  const site = meta.openGraph["og:site_name"] || meta.canonical || "";
    ...
    <div className="bg-[#111] border border-[#2a2a3e] rounded-xl overflow-hidden">
      <div className="px-6 py-4 border-b border-[#2a2a3e]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-gray-500">WhatsApp Preview</span>
        </div>
      </div>
      <div className="p-6">
        <div className="max-w-[400px] bg-black/30 rounded-lg overflow-hidden border border-[#333]">
          <div className="flex">
            {image ? (
            ...
            <div className="p-2.5 flex-1 min-w-0">
              ...
              {site && <div className="text-[10px] text-gray-600 mt-1 truncate">{site}</div>}
            </div>
          </div>
        </div>
      </div>
